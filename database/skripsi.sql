...
--
-- Struktur dari tabel `tbl_dok`
--

CREATE TABLE `tbl_dok` (
  `id_dok` int(11) NOT NULL,
  `kode_realisasi` varchar(100) NOT NULL,
  `gambar` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data untuk tabel `tbl_dok`
--

INSERT INTO `tbl_dok` (`id_dok`, `kode_realisasi`, `gambar`) VALUES
(8, '0411180011', 'img_686_455_rapat-eval_15325208078-581.png'),
(9, '0411180011', 'img_686_455_kegiatan-k_15354654059830.JPG'),
(10, '0411180011', 'img_686_455_terima-dri_15356308269962.JPG'),
(11, '0411180011', '42825102_1161700634005950_351540117627606872_n.jpg'),
(12, '0411180011', '42328915_1779517975507281_2657837266007967136_n.jpg'),
(13, '0411180011', 'gedung-dprd-31.jpg'),
(14, '0411180011', 'struktur_sekretariat1.jpg'),
(15, '0411180011', 'JKA_93221.JPG'),
(16, '0411180022', 'avtar.png'),
(17, '0411180022', '180px-Coat_of_arms_of_South_Sulawesi_svg.png');
...
CREATE TABLE `tbl_kategori_regulasi` (
...
INSERT INTO `tbl_kegiatan` (`id_kegiatan`, `nama_kegiatan`, `id_bidang`, `lokasi`, `jenis_kegiatan`, `manfaat`, `sasaran`, `tahun`, `biaya`, `sumber`, `tgl_ditetapkan`, `status`, `tgl_mulai_kegiatan`, `aparat`) VALUES
(7, 'Pengahsilan Tetap dan Tunjangan', 1, 'Desa Kabubu', 'Pembinaan', 'meningkatkan kinerja dan kesejahteraan pemerintah desa dalam menyelenggarakan tugas pemerintahan desa', 'Pemerintah Desa (kepala desa beserta aparaturnya)', 2018, '115000000', 'ADD', '2018-05-01', 'n', '0000-00-00', 16),
(8, 'SILTAP dan tunjangan BPD', 1, 'Desa Kabubu', 'Pembinaan', 'meningkatkan kinerja dan sinergitas BPD  dengan pemerintah desa dalam menyelenggarakan tugas pemerintahan desa', 'Ketua BPD, wakil ketua BPD, sekertaris, ketua bidang dan Dusun Transari', 2018, '22200000', 'ADD', '2018-05-01', 'n', '0000-00-00', 16),
(9, 'Insentif RT', 1, 'Desa Kabubu', 'Pembinaan', 'meningkatkan kinerja dan kesejahteraan serta sinergitas pemerintah desa dalam menyelenggarakan tugas pemerintahan desa', 'dusun Transari (RT I,II,III), dusun Kabubu (RT I,II,III) dan dusun Mekar Sari (RT I,II,III) ', 2018, '5400000', 'ADD', '2018-05-01', 'n', '0000-00-00', 16),
(10, 'Tunjangan kader  PTKD 5 orang ', 1, 'desa Kabubu', 'Pembinaan', 'meningkatkan kinerja dan kesejahteraan  dalam menyelenggarakan tugas yang diamanahkan oleh  pemerintah desa', 'pengelola KeuDes, koordinator PTPKD, Bendahara Desa, pelaksana Kegiatan (3 orang) ', 2018, '14700000', 'ADD', '2018-05-01', 'n', '0000-00-00', 16),
(11, 'Operasional Kantor Pemerintah Desa (belanja barang dan jasa serta belanja Modal)', 1, 'Desa Kabubu', 'Pengadaan', 'meningkatkan kinerja dan kesejahteraan pemerintah desa dalam menyelenggarakan tugas pemerintahan desa', 'pemerintah desa', 2018, '105832000', 'ADD', '2018-05-01', 'n', '0000-00-00', 16),
(12, 'Renovasi Kantor BPD', 2, 'Desa Kabubu', 'Pembangunan', 'meningkatkan kinerja dan kesejahteraan serta Sinergitas BPD dengan pemerintah desa dalam menyelenggarakan tugas pemerintahan desa', 'BPD', 2018, '51800000', 'ADD', '2018-05-01', 'y', '2018-06-02', 16),
(13, 'Pembinaan ibu-ibu PKK', 3, 'Desa Kabubu', 'Pembinaan', '', 'Ibu-ibu PKK desa Kabubu', 2018, '32790000', 'ADD', '2018-05-01', 'y', '2018-03-24', 16),
(14, 'Pembinaan Pemuda Kabubu', 3, 'Desa Kabubu', 'Pembinaan', '', 'pemuda kabubu', 2018, '40000000', 'ADD', '2018-05-01', 'y', '2018-08-04', 16),
(15, 'Pembelian Tanah Makam 25 x 100 M', 4, 'Desa Kabubu', 'Pemberdayaan', 'dapat digunakan sebagai TPU di desa Kabubu ', 'Masyarakat Desa Kabubu', 2018, '100000000', 'ADD', '2018-11-09', 'y', '2018-07-05', 16);
...
--
-- AUTO_INCREMENT for table `tbl_dok`
--
ALTER TABLE `tbl_dok`
  MODIFY `id_dok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `tbl_realisasi`
  MODIFY `id_realisasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
