          ...
          <!-- general form elements -->
            <div class="box box-primary">
                <div class="box-header with-border ">
                    ...
                    <p><b><a href="<?= base_url()?>realisasi/detail/<?= $value->id_kegiatan ?>"><?= $value->nama_kegiatan ?></a> </b></p>
                    </center>
                    <div class="row ">
                    ...
                    <center>
                    <a href="<?= base_url()?>realisasi/detail/<?= $value->id_kegiatan ?>" class="btn btn-primary">Detail</a>
                    </center>
                </div>
            </div>
        </div>
